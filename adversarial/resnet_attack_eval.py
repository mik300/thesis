...
def main():
    ...
    if args.adv_AT == 1:
        ...
        AT_suffix = ""
    adv_data_path = args.adv_data_dir + AT_suffix + args.adv_neural_network + adv_namebit + adv_namequant + "_" + adv_execution_type + adv_conv_axx_levels_string + "_" + args.dataset + "_" + args.activation_function + "_" + attack_type + attack_parameters + ".pt"
    ...
    if args.save_data:
        ...
        if args.adv_AT == 1:
            pkl_path = "./adversarial/results_pkl/" + "AT/" + attack_type + attack_parameters + "/" + args.adv_neural_network + "/" + adv_execution_type + adv_conv_axx_levels_string + "/" + args.neural_network + "_" + args.execution_type + conv_axx_levels_string + "_" + "param_" + param_execution_type + ".pkl"
        else:
