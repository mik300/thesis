...
if args.adv_AT == 1:
    ...
    AT_suffix = ""
pkl_file_float_float = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_float_param_float.pkl"
with open(pkl_file_float_float, "rb") as file: 
    loaded_data_float_float = pickle.load(file)

pkl_file_quant_float = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_quant_param_float.pkl"
with open(pkl_file_quant_float, "rb") as file:  
    loaded_data_quant_float = pickle.load(file)

pkl_file_transaxx_float = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_transaxx{conv_axx_levels_string}_param_float.pkl"
with open(pkl_file_transaxx_float, "rb") as file: 
    loaded_data_transaxx_float = pickle.load(file)



pkl_file_float_quant = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_float_param_quant.pkl"
with open(pkl_file_float_quant, "rb") as file:  
    loaded_data_float_quant = pickle.load(file)

pkl_file_quant_quant = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_quant_param_quant.pkl"
with open(pkl_file_quant_quant, "rb") as file:  
    loaded_data_quant_quant = pickle.load(file)

pkl_file_transaxx_quant = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_transaxx{conv_axx_levels_string}_param_quant.pkl"
with open(pkl_file_transaxx_quant, "rb") as file:  
    loaded_data_transaxx_quant = pickle.load(file)



pkl_file_float_transaxx = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_float_param_transaxx.pkl"
with open(pkl_file_float_transaxx, "rb") as file:  
    loaded_data_float_transaxx = pickle.load(file)

pkl_file_quant_transaxx = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_quant_param_transaxx.pkl"
with open(pkl_file_quant_transaxx, "rb") as file:  
    loaded_data_quant_transaxx = pickle.load(file)

pkl_file_transaxx_transaxx = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type}/{args.neural_network}_transaxx{conv_axx_levels_string}_param_transaxx.pkl"
...
pkl_file_float_float = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_float_param_float.pkl"
with open(pkl_file_float_float, "rb") as file: 
    loaded_data_float_float = pickle.load(file)

pkl_file_quant_float = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_quant_param_float.pkl"
with open(pkl_file_quant_float, "rb") as file:  
    loaded_data_quant_float = pickle.load(file)

pkl_file_transaxx_float = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_transaxx{conv_axx_levels_string}_param_float.pkl"
with open(pkl_file_transaxx_float, "rb") as file: 
    loaded_data_transaxx_float = pickle.load(file)



pkl_file_float_quant = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_float_param_quant.pkl"
with open(pkl_file_float_quant, "rb") as file:  
    loaded_data_float_quant = pickle.load(file)

pkl_file_quant_quant = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_quant_param_quant.pkl"
with open(pkl_file_quant_quant, "rb") as file:  
    loaded_data_quant_quant = pickle.load(file)

pkl_file_transaxx_quant = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_transaxx{conv_axx_levels_string}_param_quant.pkl"
with open(pkl_file_transaxx_quant, "rb") as file:  
    loaded_data_transaxx_quant = pickle.load(file)



pkl_file_float_transaxx = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_float_param_transaxx.pkl"
with open(pkl_file_float_transaxx, "rb") as file:  
    loaded_data_float_transaxx = pickle.load(file)

pkl_file_quant_transaxx = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_quant_param_transaxx.pkl"
with open(pkl_file_quant_transaxx, "rb") as file:  
    loaded_data_quant_transaxx = pickle.load(file)

pkl_file_transaxx_transaxx = f"adversarial/results_pkl/{AT_suffix}{attack_type}_{attack_parameters}/{args.adv_neural_network}/{adv_execution_type+adv_conv_axx_levels_string}/{args.neural_network}_transaxx{conv_axx_levels_string}_param_transaxx.pkl"
with open(pkl_file_transaxx_transaxx, "rb") as file:  
    loaded_data_transaxx_transaxx = pickle.load(file)
